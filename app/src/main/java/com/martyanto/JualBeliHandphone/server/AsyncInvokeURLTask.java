package com.martyanto.JualBeliHandphone.server;
...
public class AsyncInvokeURLTask extends AsyncTask<Void, Void, String> {
    public String mNoteItWebUrl = "www.martyanto.com";
    ...
    public String url_server ="https://martyanto.000webhostapp.com/xphone/";
